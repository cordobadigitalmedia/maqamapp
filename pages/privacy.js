  ...
  return (
    <div className="bg-white text-gray-600 work-sans leading-normal text-base tracking-normal">
      ...
      <section className="bg-white pt-2 pb-0">
        <div className="container mx-auto items-center pt-2 pb-2">
          <div className="block uppercase tracking-wide no-underline hover:no-underline font-bold text-gray-800 text-xl">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Maqam App.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Maqam App, accessible from{" "}
                <a
                  href="https://maqamapp.vercel.app/"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://maqamapp.vercel.app/
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>
              <p>By email: support@cordobadigitalmedia.com</p>
            </li>
            <li>
              <p>
                By visiting this page on our website:{" "}
                <a
                  href="https://maqamapp.vercel.app/about"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://maqamapp.vercel.app/about
                </a>
              </p>
            </li>
          </ul>
